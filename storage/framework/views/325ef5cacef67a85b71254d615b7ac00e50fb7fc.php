			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Nguyen Viet Thai</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0969243xxx</a></li>
					</ul>
				</div>
			...
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						...
						<div class="cart">
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (<?php echo e(Session('cart')->totalQty); ?>)
								<i class="fa fa-chevron-down"></i></div>
							<div class="beta-dropdown cart-body">

								<?php $__currentLoopData = $productCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="cart-item">
						...
						<?php else: ?>
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Giỏ hàng (0)
								<i class="fa fa-chevron-down"></i></div>
							<div class="beta-dropdown cart-body">
						<?php endif; ?>
					</div>
